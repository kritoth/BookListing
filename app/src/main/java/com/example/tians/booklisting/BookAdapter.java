...
public class BookAdapter extends ArrayAdapter<Book> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        // Get the {@Bitmap} of the {@Book} from the {@link QueryUtils.getBooksImage(String key)} and sets it the ImageView
        thumbnailImgView.setImageBitmap(QueryUtils.getBooksImage(currBook.getId()));
